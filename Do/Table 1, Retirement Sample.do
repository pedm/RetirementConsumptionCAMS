...
--Notes of Concern--
1. below two drops makes food means decrease instead of increase
	drop if recollect == . & retired == 1
	drop if recollect == . & retired == 1

2. eliminating principal is done by age range, and a different ratio is used for 55-64
   and >65 which might drive the fall in spending at retirement for total/nondurables
